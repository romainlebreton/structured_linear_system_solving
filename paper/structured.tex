...
$\mathscr{P}=(P_{\mT_{i,j}})_{1 \le i \le p,1 \le j \le q}$, together
...
nullspace basis. Instead, we chose to reduce the nullspace dimension by
adding a new block of equations, 
